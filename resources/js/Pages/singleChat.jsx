...
export default function SingleChat({ messages, user, receiver }) {
    ...
    return (
        <div className="w-full">
                ...
                {messages ? (
                    ...
                    <div className="w-full py-10 flex justify-center">
                        <div className="flex flex-col items-center">
                            ...
                            <button className="p-2 mt-2 bg-blue-500 text-white rounded-md focus:outline-none">
                                Lihat Profile
                            </button>
                        </div>
                    </div>
            ...
            <div className="bg-black sticky bottom-0 min-w-full lg:w-3/4 border-t border-white border-opacity-20 py-4 px-6 gap-4">
                {loading ? (
